...
1.1. If you are importing a file, move all your custom code like functions and imports to `keymap_common.h` in the same directory, that will be imported by the new generated keymap.
